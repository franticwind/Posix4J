...
extern "C" {
#endif
#undef posix_CPtr_CBYTE_TYPE
#define posix_CPtr_CBYTE_TYPE 0L
#undef posix_CPtr_CSHORT_TYPE
#define posix_CPtr_CSHORT_TYPE 1L
#undef posix_CPtr_CINT_TYPE
#define posix_CPtr_CINT_TYPE 2L
#undef posix_CPtr_CLONG_TYPE
#define posix_CPtr_CLONG_TYPE 3L
#undef posix_CPtr_CFLT_TYPE
#define posix_CPtr_CFLT_TYPE 4L
#undef posix_CPtr_CDBL_TYPE
#define posix_CPtr_CDBL_TYPE 5L
#undef posix_CPtr_CPTR_TYPE
#define posix_CPtr_CPTR_TYPE 6L
/*
 * Class:     posix_CPtr
 * Method:    init
 * Signature: ()J
